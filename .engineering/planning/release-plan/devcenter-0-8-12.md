...
id: release-plan:devcenter-0-8-12
kind: release-plan
status: superseded
title: Release DevCenter 0.8.12
summary: Publish the production CSP editor-style fix as patch release 0.8.12.
relations:
- delivers: story:production-editor-csp-styling
revision: 4
---
# Release plan: DevCenter 0.8.12

## Scope

Publish the production CSP nonce bridge and its hosted-workbench regression coverage as DevCenter 0.8.12.
...
2. Create the immutable 0.8.12 tag from that merge.
