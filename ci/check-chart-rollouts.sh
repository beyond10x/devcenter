...
grep -q 'chown 65532:65532 /var/lib/substrate /var/run/substrate /var/run/substrate-tls /var/run/substrate-tls/tls.crt /var/run/substrate-tls/tls.key' "$rendered"
